...
function AdminTopBarComponent() {
    ...
    const getButtonStyle = (path) => ({
        fontWeight: location.pathname === path ? 'bold' : 'normal', color: 'inherit', // Somehow this is required to make the color work
        textDecoration: 'none',
    });
